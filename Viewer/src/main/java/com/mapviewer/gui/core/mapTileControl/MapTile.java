...
//    
//==============================================================================
package com.mapviewer.gui.core.mapTileControl;
...
public class MapTile {
    ...
    public MapTile(TileSource source, int xtile, int ytile, int zoom) {
        ...
        if (this.tileLocation.startsWith("http")) {
            Image delayed_img = new Image(this.getClass().getResource("/com/mapviewer/mapImages/hourglass.png").toString());
    ...
    private void loadImage(String url, boolean localImage) {
        ...
        img.errorProperty().addListener( (arg) -> {
        	try {
				...
				if (file.exists())
	        		...
	        		loadImage(this.getClass().getResource("/com/mapviewer/mapImages/error.png").toString(), true);
			}
        	catch (URISyntaxException e) {
        		loadImage(this.getClass().getResource("/com/mapviewer/mapImages/error.png").toString(), true);
