...
package com.mapviewer.gui.is.interfaces.maptiles;
...
public interface TileSource {
     ...
     * @return transforms longitude and latitude to pixel space (as if all tiles at specified zoom level where joined)
     */
    Point latLonToXY(Coordinate point, int zoom);
     ...
     */
    Coordinate xyToLatLon(Point point, int zoom);
     ...
     * @return WGS84 Coordinates of given point
     */
    Coordinate xyToLatLon(int x, int y, int zoom);
     ...
     * @return x and y tile indices
     */
    TileXY latLonToTileXY(Coordinate point, int zoom);
     ...
     */
    Coordinate tileXYToLatLon(TileXY xy, int zoom);
     ...
     * @return WGS84 coordinates of given tile
     */
    Coordinate tileXYToLatLon(MapTile tile);
     ...
     * @return WGS84 coordinates of given tile
     */
    Coordinate tileXYToLatLon(int x, int y, int zoom);
